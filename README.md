...
**Localex** is a lightweight SwiftUI showcase app demonstrating Apple’s [**Natural Language** framework](https://developer.apple.com/documentation/naturallanguage/) for classical Natural Language Processing (NLP) tasks such as tokenization, lemmatization, language identification, and part-of-speech tagging — all fully on-device.
